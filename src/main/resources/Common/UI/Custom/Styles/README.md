...
5. **No per-page style files.** All named styles live in `Styles/`. Subsystem folders (`Pages/BlueprintBench/`, `Pages/StencilRadial/`) contain only layout `.ui` files — no `*Styles.ui` files.
