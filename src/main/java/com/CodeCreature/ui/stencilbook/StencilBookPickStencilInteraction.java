 ...
 */
public class StencilBookPickStencilInteraction extends SimpleInstantInteraction {
    ...
    public static final BuilderCodec<StencilBookPickStencilInteraction> CODEC =
            BuilderCodec.builder(StencilBookPickStencilInteraction.class,
                    StencilBookPickStencilInteraction::new, SimpleInstantInteraction.CODEC)
                    .build();
    ...
    protected void firstRun(@Nonnull InteractionType type,
        ...
        DebugLogger.logHytale(STENCIL_BOOK, "[StencilBook] Gave stencil for %s to player %s", entry.recipeId(), playerRef.getUuid());
    }
