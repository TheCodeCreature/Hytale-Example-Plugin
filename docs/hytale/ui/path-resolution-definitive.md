...
sources:
  ...
  - "src/main/resources/Common/UI/Custom/Pages/BlueprintBench/ — plugin .ui files (verified working)"
---
...
```java
// File at: src/main/resources/Common/UI/Custom/Pages/BlueprintBench/BlueprintBenchPage.ui
...
cmd.append("#Container", "Pages/BlueprintBench/SetFilterButton.ui");
```
...
```java
// This sets the Background on an element defined in BlueprintBenchPage.ui
// The path resolves relative to Pages/BlueprintBench/ directory
...
|---|---|---|---|
| `Pages/BlueprintBench/BlueprintBenchPage.ui` | `Common/RecipesIcon.png` | `"../../Common/RecipesIcon.png"` | `Common/RecipesIcon.png` |
| `Pages/BlueprintBench/BlueprintBenchPage.ui` | `Common/BlockSelectorSlotBackground.png` | `"../../Common/BlockSelectorSlotBackground.png"` | `Common/BlockSelectorSlotBackground.png` |
| `Pages/BlueprintBench/CostCell.ui` | `Common/BlockSelectorSlotBackground.png` | `"../../Common/BlockSelectorSlotBackground.png"` | `Common/BlockSelectorSlotBackground.png` |
| `Pages/BlueprintBench/RecipeIconCell.ui` | `Common/BlockSelectorSlotBackground.png` | `"../../Common/BlockSelectorSlotBackground.png"` | `Common/BlockSelectorSlotBackground.png` |
...
|---|---|---|
| `Pages/BlueprintBench/*.ui` | `$C = "../../Common.ui";` | `Common.ui` |
...
|---|---|
| `cmd.append("Pages/BlueprintBench/BlueprintBenchPage.ui")` | `Pages/BlueprintBench/BlueprintBenchPage.ui` |
| `cmd.append("#SetFilters", "Pages/BlueprintBench/SetFilterButton.ui")` | `Pages/BlueprintBench/SetFilterButton.ui` |
| `cmd.append("#MaterialGroups", "Pages/BlueprintBench/MaterialGroupButton.ui")` | `Pages/BlueprintBench/MaterialGroupButton.ui` |
| `cmd.append("#CostGrid", "Pages/BlueprintBench/CostCell.ui")` | `Pages/BlueprintBench/CostCell.ui` |
...
If `#SomeElement` is defined in `Pages/BlueprintBench/BlueprintBenchPage.ui`, then the resolution is:
```
Pages/BlueprintBench/ + ../../Common/RecipesIcon.png → Common/RecipesIcon.png ✓
```

If you instead used a `Custom/`-root-relative path:
```java
cmd.set("#SomeElement.Background", "Common/RecipesIcon.png");  // WRONG for element in Pages/BlueprintBench/
```
This would resolve to `Pages/BlueprintBench/Common/RecipesIcon.png` — which doesn't exist.

---

## 6. Key Questions — Answered

### Q: When `Pages/BlueprintBench/Foo.ui` references `"../../Common/RecipesIcon.png"`, what is the resolved path?

**A:** `Common/RecipesIcon.png` (under `Common/UI/Custom/`).

Step by step:
1. File is at `Pages/BlueprintBench/Foo.ui`
2. Directory is `Pages/BlueprintBench/`
