# Review: Dynamic Placeholder List — StencilSelectionPage
...
```mermaid
graph TB
    subgraph UI["StencilBookPage.ui"]
        RecipeGrid["#RecipeGrid\nItemGrid"]
        PlaceholderList["#PlaceholderList\nDynamic rows"]
        RowInputSlot["#RowInputSlot\nItemGrid per row"]
    end

    subgraph Server["StencilSelectionPage.java"]
