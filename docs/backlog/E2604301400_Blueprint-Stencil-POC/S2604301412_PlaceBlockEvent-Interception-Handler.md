...
## User Story
As a **player**, I want to right-click with a blueprint stencil block and have it place the block using my resources so that I can build without consuming the stencil item.
