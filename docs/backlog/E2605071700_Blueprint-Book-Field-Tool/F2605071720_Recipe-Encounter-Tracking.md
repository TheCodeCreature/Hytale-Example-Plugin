...
## Description
Per-player tracking of which crafting recipes have been "encountered" (discovered at a bench or successfully resolved). Gates access to the Blueprint Book's Quick Select and Block Pick features.
...
- **Then** all 15 recipes are still accessible via the Blueprint Book
