...
## User Story
As a **player**, I want **the Stencil Crafting to show placeable recipes from ALL registered benches** so that **I don't have to visit different benches to arm my placeholder with different block types**.
...
- **When** the player opens the Stencil Crafting
