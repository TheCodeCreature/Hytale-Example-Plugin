...
- **What Survives:** `PlaceBlockMetadata` (unchanged), `BlueprintBenchRecipeMutator` (shadow recipes still useful as a recipe catalog), `PlaceBlockPlacementSystem` (unchanged, Phase 3).
