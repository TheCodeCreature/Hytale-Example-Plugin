...
id: S2605191122
type: story
title: "Add Raw Cost to BlueprintSelectionPage"
status: backlog
priority: medium
feature: F2605191120
epic: E2605191100
...
# Add Raw Cost to BlueprintSelectionPage

## User Story
As a **player**, I want **the blueprint bench recipe list to show raw material costs** so that **I can compare recipes by their true cost**.
