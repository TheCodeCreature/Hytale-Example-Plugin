...
- [ ] PlacementCostScaler does not double-charge stencil-tagged items
...
| ID | Title | Status |
|----|-------|--------|
| F2604301410 | Stencil Stencil Placement Interception | backlog |
| F2604301420 | PlacementCostScaler Stencil Guard | backlog |
