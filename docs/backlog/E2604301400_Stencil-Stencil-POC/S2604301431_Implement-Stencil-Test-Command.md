...
## User Story
As a **developer**, I want a `/stencil` command that gives me a stencil stencil item so that I can test the stencil placement flow without needing the Stencil Crafting UI.
