...
id: F2604301410
type: feature
title: "Stencil Stencil Placement Interception"
status: backlog
priority: high
epic: E2604301400
created: 2026-04-30
...
# Stencil Stencil Placement Interception
...
### Checklist
- [ ] PlaceBlockEvent handler detects stencil-tagged items via BSON metadata
...
- **Given** the player holds a `Wall_Cobble` stencil (BSON: `{stencil: true, recipeId: "cobble_wall"}`) and has 48× `Rock_Stone_Cobble` in inventory
...
| ID | Title | Status |
|----|-------|--------|
| S2604301411 | Stencil Stencil Metadata Utility | backlog |
