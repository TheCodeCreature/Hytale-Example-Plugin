...
- [ ] Visual treatment is adapted for the radial context (compact, at-a-glance) — not a clone of the StencilBook detail panel
...
## Notes
- PO recommendation: tint or dim the cost icon, don't replicate full StencilBook treatment. Keep it "at a glance."
